      ...
      <Match when={!isMobile()}>
        ...
        >
          ...
          >
            <div
              data-sidebar="sidebar"
              class="flex size-full flex-col bg-sidebar group-data-[variant=floating]:border group-data-[variant=sidebar]:border-r border-sidebar-border group-data-[variant=floating]:shadow"
            >
              {local.children}
            </div>
          </div>
...
type SidebarTriggerProps<T extends ValidComponent = "button"> = ComponentProps<
  typeof Button<T>
> & {
...
const SidebarInset: Component<ComponentProps<"main">> = (props) => {
  ...
  return (
    <main
      class={cn(
        "relative flex min-h-svh h-full w-full flex-1 flex-col bg-background",
        "peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] md:peer-data-[variant=inset]:squircle-sm md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:border",
        local.class,
      )}
      {...others}
    />
...
const SidebarHeader: Component<ComponentProps<"div">> = (props) => {
  ...
  return (
    <div
      data-sidebar="header"
      class={cn("flex flex-col gap-3 p-2 border-b", local.class)}
      {...others}
    />
  );
};
...
const SidebarContent: Component<ComponentProps<"div">> = (props) => {
  ...
  return (
    <div
      ...
      class={cn(
        "flex min-h-0 flex-1 flex-col overflow-auto group-data-[collapsible=icon]:overflow-hidden p-2 gap-1",
        local.class,
      )}
      {...others}
    />
...
const SidebarGroupLabel = <T extends ValidComponent = "div">(
  ...
  return (
    <Polymorphic<SidebarGroupLabelProps>
      ...
      class={cn(
        "flex h-8 shrink-0 items-center px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-in-out-circ focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
const SidebarGroupContent: Component<ComponentProps<"div">> = (props) => {
  ...
  return (
    <div
      ...
      class={cn("w-full text-base", local.class)}
      {...others}
    />
  );
};
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full rounded-sm items-center gap-2 overflow-hidden py-2 px-2.5 text-left text-base outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 aria-[current=page]:bg-sidebar-accent aria-[current=[page]:font-medium aria-[current=page]:ring-1 aria-[current=page]:ring-black/10 aria-[current=page]:ring-inset data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "py-1.5 text-base !leading-tight",
        sm: "h-7 text-sm",
  ...
  return (
    <Polymorphic<SidebarMenuSubButtonProps>
      ...
      class={cn(
        ...
        "aria-[current=page]:bg-sidebar-accent aria-[current=page]:ring-1 aria-[current=page]:ring-border aria-[current=page]:text-sidebar-accent-foreground",
